...
const Lost = () => {
  ...
  const changeHandler = (e) => {
    ...
    setFormData((prevState) => ({
      ...prevState,
      [name]: name === 'Picture' ? e.target.files[0] : value.trim(),
    }));
  };
      ...
      <form onSubmit={submitHandler}>
        <div className="mr-3 ml-3 justify-center">
          ...
          <div className="grid gap-6 mb-6 sm:grid-cols-2 ml-3 mr-3">
            ...
            {/* Where Lost */}
            <div>
              <label htmlFor="whereLost" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                Where Lost
              </label>
              <input
                type="text"
            ...
            {/* Date Lost */}
            <div>
              <label htmlFor="whenLost" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                Date Lost
              </label>
              <input
                type="date"
            ...
            <div>
              ...
              >
                ...
                <option value="london">LondonLondon</option>
